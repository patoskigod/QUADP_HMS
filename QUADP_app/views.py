...
def doctor_signup_view(request):
    ...
    if request.method=='POST':
        ...
        if userForm.is_valid() and doctorForm.is_valid():
            ...
            instance.set_password(userForm.cleaned_data['password'])
            instance.save()   
            models.Doctor.objects.create(
                address= doctorForm.cleaned_data['address'],
                user= instance,
                profile_pic= doctorForm.cleaned_data['profile_pic'],
    ...
    if request.method=='POST':
        ...
        if userForm.is_valid() and patientForm.is_valid():
            ...
            models.Patient.objects.create(
                ...
                user= instance,
                profile_pic= patientForm.cleaned_data['profile_pic'],
...
def account_login(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if user and user.is_active:
                login(request,user)
                if login_user.is_authenticated and user.is_Admin:
                    return redirect('admin-dashboard')
            else:
    ...
    return render(request,'hospital/adminlogin.html',context)
...
def doctor_login(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if user and user.is_active:
                ...
                login(request,user)
                if login_user.is_authenticated and user.is_Doctor:
                    return redirect('doctor-dashboard')
            else:
                messages.error(request,'Username or Password is incorrect, Try again or Contact Admin',extra_tags = 'alert alert-warning alert-dismissible show' )
                return redirect('doctorlogin') 
    ...
    return render(request,'hospital/doctorlogin.html',context)
...
def patient_login(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if user and user.is_active:
                login(request,user)
                if login_user.is_authenticated and user.is_Patient:
                    return redirect('patient-dashboard')
            else:
                messages.error(request,'Username or Password is incorrect, Try again or Contact Admin',extra_tags = 'alert alert-warning alert-dismissible show' )
                return redirect('patientlogin') 
    ...
    return render(request,'hospital/patientlogin.html',context)
